...
async function fetchJiraStory(storyNumber) {
    ...
    try {
        const response = await axios_1.default.get(`${jiraBaseUrl}${jiraApiEndpoint}`, {
            auth: {
...
async function createJiraStory(summary, description) {
    ...
    try {
        const response = await axios_1.default.post(`${jiraBaseUrl}${jiraApiEndpoint}`, newStoryData, {
            auth: {
                username: jiraUsername,
                password: jiraApiToken
            },
...
async function fetchSnowTicket(ticketNumber) {
    ...
    try {
        const response = await axios_1.default.get(`${SnowBaseUrl}${SnowApiEndpoint}`, {
            auth: {
...
axios.VERSION = (__webpack_require__(46).version);
...
var defaults = {
  ...
  env: {
    FormData: __webpack_require__(47)
  },
...
var CombinedStream = __webpack_require__(49);
...
var asynckit = __webpack_require__(56);
...
var util = __webpack_require__(41);
var Stream = (__webpack_require__(32).Stream);
var DelayedStream = __webpack_require__(50);
...
module.exports =
{
  parallel      : __webpack_require__(57),
  serial        : __webpack_require__(64),
  serialOrdered : __webpack_require__(65)
};
...
var iterate    = __webpack_require__(58)
  , initState  = __webpack_require__(62)
  , terminator = __webpack_require__(63)
  ;
...
var defer = __webpack_require__(60);
...
var abort = __webpack_require__(61)
...
var serialOrdered = __webpack_require__(65);
